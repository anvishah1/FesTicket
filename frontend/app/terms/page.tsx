    ...
    <div className="min-h-screen flex flex-col bg-[var(--bg)]">
      ...
      <main className="flex-1">
        <div className="container max-w-3xl py-12 md:py-16">
          <h1 className="text-3xl md:text-4xl font-bold text-[#29104A]">Terms of use</h1>
          <p className="mt-4 text-slate-600 leading-relaxed">
            By using tiqr you agree to the basics below. This is a short, honest summary
            of the rules for using the platform.
          </p>

          <h2 className="mt-10 text-xl font-semibold text-[#29104A]">Your account</h2>
          ...
          <h2 className="mt-10 text-xl font-semibold text-[#29104A]">Bookings &amp; payments</h2>
          <p className="mt-3 text-slate-600 leading-relaxed">
          ...
          <h2 className="mt-10 text-xl font-semibold text-[#29104A]">Acceptable use</h2>
          <p className="mt-3 text-slate-600 leading-relaxed">
