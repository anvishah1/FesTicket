    ...
    <div className="min-h-screen flex flex-col bg-[var(--bg)]">
      ...
      <main className="flex-1">
        <div className="container max-w-3xl py-12 md:py-16">
          <h1 className="text-3xl md:text-4xl font-bold text-[var(--text-primary)]">Contact us</h1>
          ...
          <div className="mt-8 rounded-2xl bg-[var(--surface)] shadow-md p-6">
          ...
          <p className="mt-8 text-[var(--text-slate)] leading-relaxed">
            Running a fest and want an admin account? Start at{" "}
            <a href="/admin/signup" className="text-[var(--text-secondary)] font-medium underline">
              admin sign up
            </a>
            . Already have a fest key as a student? Head to{" "}
            <a href="/signup" className="text-[var(--text-secondary)] font-medium underline">
              sign up
            </a>
            .
          </p>
