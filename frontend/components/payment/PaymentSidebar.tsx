    ...
    <div className="rounded-lg p-4 border bg-white shadow-sm">
      ...
      <div className="mt-4 space-y-2 text-sm">
        <div className="flex justify-between">
          ...
          <span className="font-mono text-xs bg-slate-100 px-2 py-0.5 rounded">{orderId}</span>
        </div>

        <div className="border-t my-2 pt-2">
          <div className="flex items-center justify-between">
            <div className="font-semibold">Total Amount</div>
            <div className="text-2xl font-bold text-primary-600">{formatPaise(amount)}</div>
          </div>
        </div>
      </div>
